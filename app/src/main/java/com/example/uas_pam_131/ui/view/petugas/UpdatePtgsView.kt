...
fun UpdateScreen(
    ...
    onNavigate:()-> Unit,
    viewModel: UpdatePtgsViewModel = viewModel(factory = PenyediaViewModel.Factory)
){
    ...
    Scaffold (
        ...
        topBar = {
            CostumeTopAppBar(
                title = DestinasiUpdatePtgs.titleRes,
        ...
        EntryBody(
            ...
            insertPtgsUiState = viewModel.ptgsupdateUiState,
